...
public class Mob extends Rectangle {
	...
	public void physic() {
		...
		if(walkSpeed > 0) {
				...
				for(int i = 0; i < Screen.bullets.size(); i++)
				{
					if(this.contains(Screen.bullets.get(i).x, Screen.bullets.get(i).y ))
					{
						
						Screen.bullets.get(i).inGame = false;
					}
				}
		}
	}
